...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <title><?php echo $this->layout->getTitle(); ?></title>
		...
		<meta name="description" content="Página Web de la Escuela de Informática de la Universidad Tecnológica Metropolitana del Estado de Chile" />
		<meta name="keywords" content="Web, Escuela, Informática, Universidad, Tecnológica, Metropolitana, Chile, UTEM" />
    ...
    <header>
		...
		<nav class="vertical menu">
            <ul>
                ...
                <li><a href="<?php echo base_url()?>laboral">Laboral</a></li>
                <li><a href="<?php echo base_url()?>servicio">Servicio</a></li>
                <li><a href="mailto:hpinche@utem.cl">Contacto</a></li>
            </ul>
        </nav>
    </header>
    <div>
